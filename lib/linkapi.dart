class AppLink {
  ...
  static const String getRoutine = "/coachiko/get_routine_data_new.php";
  static const String fetchDirectory = "/coachikoFollowApp/";
  static const String signUpKey = "${authDirectory}register.php";
  static const String signInKey = "$httpServer${authDirectory}login.php";
  ...
  static const String getDietData =
