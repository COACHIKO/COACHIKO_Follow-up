...
import '../../../../main.dart';
import '../../coach_area/diet_presentation/diet_making_page.dart';
                ...
                children: [
                              ...
                              children: [
                                ...
                                controllerget.isSelectedMan
                                    ? Column(
                                        children: [
                                          Form(
                                            key: controllerget.formKey.value,
                                            child: Column(
                                              children: [
                                                SizedBox(
                                                  height: 70.h,
                  ...
                  Scaffold(
                      ...
                      body: GetBuilder<DietMakingController>(
                        ...
                        builder: (coachHomeController) => SingleChildScrollView(
                          child: Column(
                            children: [
                              Padding(
                                padding:
                              ...
                              SizedBox(
                                  ...
                                  child: ListView.builder(
                                    shrinkWrap: true,
                                    itemCount: coachHomeController
                                        .filteredFoodList.length,
                                    itemBuilder: (context, index) {
                                      bool isSelected = coachHomeController
                                          .selectedIndexes
                                          .contains(index);
                                    ...
                                    child: MaterialButton(
                                      ...
                                      onPressed: () async {
                                        List<String> selectedFoodNames =
                                            coachHomeController.filteredFoodList
                                                .asMap()
                                                .entries
                                                .where((entry) =>
                                                    coachHomeController
                              ...
                              children: [
                                ...
                                Center(
                                  child: Column(
                                    children: [
                                      Text(
                                        "Hello, ${myServices.sharedPreferences.getString("first_name")} ${myServices.sharedPreferences.getString("second_name")}",
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyMedium,
                                      ),
                                      ...
                                      Text(
                                        "You're a ${controllerget.isSelectedMan ? "Man" : "Woman"} Weights ${controllerget.weight}kg with ${controllerget.tall}cm Tall",
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyMedium,
                                      ),
                                      ...
                                      Text(
                                        "your waist is ${controllerget.waist}cm your neck is ${controllerget.neck}cm",
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyMedium,
                                      ),
                                      ...
                                      controllerget.arms.value.isNotEmpty
                                          ? Text(
                                              "Your arm is ${controllerget.arms}",
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .bodyMedium,
                                            )
                                          : controllerget.chest.isNotEmpty
                                              ? Text(
                                                  "Your chest is ${controllerget.chest}",
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .bodyMedium,
                                                )
                                              : controllerget.calves.isNotEmpty
                                                  ? Text(
                                                      "Your calves is ${controllerget.calves}",
                                                      style: Theme.of(context)
                                                          .textTheme
                                                          .bodyMedium,
                                                    )
                                                  : controllerget.hip.isNotEmpty
                                                      ? Text(
                                                          "Your calves is ${controllerget.hip}",
                                                          style:
                                                              Theme.of(context)
                                                                  .textTheme
                                                                  .bodyMedium,
                                                      ...
                                                      : Text(
                                                          "Your Goal is ${controllerget.isSelectedLoseWeight ? "Lose Weight" : controllerget.isSelectedMaintainWeight ? "Maintain Weight" : "Gain Weight"}"),
                                      const SizedBox(
                                        height: 10,
                                      ),
                                      Text(controllerget.isLowActivitySelected
                                          ? "You Don't Train At All"
                                          : controllerget
                                                  .isLightActivitySelected
                                              ? "You Train 1 or 2 Times"
                                              : controllerget
                                                      .isModerateActivitySelected
                                                  ? "You Train 3 to 5 Times"
                                                  : controllerget
