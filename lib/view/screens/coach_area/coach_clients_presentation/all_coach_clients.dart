                ...
                child: Card(color:  dark? const Color(0xFF1C1C1E):CColors.primary,
                  child: ListTile(
                    title:Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(myServices.sharedPreferences.getInt("user")!=dietMakingController.coachClients[index].id? "Client: ${dietMakingController.coachClients[index].firstName}${dietMakingController.coachClients[index].secondName}" : "Its You",style: const TextStyle(color: Colors.white),),
                         Icon(CupertinoIcons.smallcircle_fill_circle_fill,color:dietMakingController.coachClients[index].isActive==1 ? Colors.green:Colors.white,size: 22,),
                      ],),
                    subtitle: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Username: ${dietMakingController.coachClients[index].username}',style: const TextStyle(color: Colors.white),),
                        Text('Email: ${dietMakingController.coachClients[index].email}',style: const TextStyle(color: Colors.white),),
                        Text('Subscription Date: ${dietMakingController.coachClients[index].subscriptionDate.year}-${dietMakingController.coachClients[index].subscriptionDate.month.toString().padLeft(2, '0')}-${dietMakingController.coachClients[index].subscriptionDate.day.toString().padLeft(2, '0')}',style: const TextStyle(color: Colors.white),),
                        Text('Subscription Lenth: ${dietMakingController.coachClients[index].subscriptionLenth} Month',style: const TextStyle(color: Colors.white),),
