...
class WorkoutPlanPreview extends StatelessWidget {
  ...
  Widget _buildEmptyState(BuildContext context, WorkoutPlanPreviewController controller) {
    return Scaffold(
      body: Padding(
  ...
  Widget _buildRoutinesList(BuildContext context, List<Routine> routines,) {
    final workoutPlanController = Get.put(WorkoutPlanPreviewController());
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        routine.exercises[0].exerciseID.isEmpty?
                        SizedBox(
                          width: double.maxFinite,
                          child:  MaterialButton(
                            ...
                            onPressed: ()   {
                                Get.to(() => ExerciseSearchPage(id: id,routineId: int.parse(routine.routineId),));
                              },
                            color: CColors.primary,
                        ...
                        SizedBox(
                          ...
                          child:  MaterialButton(
                            ...
                            onPressed: ()   {
                               Get.to(() => EditExercisePage(selectedExercises: routine.exercises.toList(), id: id.toString(),routineId: routine.routineId,));},
                            color: CColors.primary,
